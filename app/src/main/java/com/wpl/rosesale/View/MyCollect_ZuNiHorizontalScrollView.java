...
/**
 * 具有阻尼效果的HorizontalScrollView
 * Created by 培龙 on 2016/11/1.
 */

public class MyCollect_ZuNiHorizontalScrollView extends HorizontalScrollView {
    ...
    public MyCollect_ZuNiHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        post(new Runnable() {
            ...
            @Override
            public void run() {
                width = getChildAt(0).findViewById(R.id.myCollectItem_rightLayout).getMeasuredWidth();
            }
        });
    }
    ...
    public void isNeedMove() {
        ...
        Log.i("wjx", "width:" + width);
        if (scrollY == 0 && (scrollX == 0 || scrollX == width)) {
            isMoveing = true;
        }
    }
