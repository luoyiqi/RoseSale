...
public class MyCollect_ScrollView extends ScrollView {
    ...
    public MyCollect_ScrollView(Context context) {
        super(context);
        initView();
    }

    public MyCollect_ScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    public MyCollect_ScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
