...
public class SyJrtj_Presenter {
    private SyListView_View view;
    private SyListView_Model model;
    private Handler handler;

    public SyJrtj_Presenter(SyListView_View view) {
        this.view = view;
        model = new SyListView_ModelImpl();
        this.handler = new Handler();
    }

    public void loadJrtj(Context context, String showArea) {
        model.loadJrtj(context, showArea, new SyListView_Listener() {
            @Override
            ...
            @Override
            public void setJrtj(final List<Map<String, String>> list) {
