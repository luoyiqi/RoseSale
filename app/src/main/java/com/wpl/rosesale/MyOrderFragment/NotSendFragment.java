 ...
 */
public class NotSendFragment extends Fragment implements MyOrder_View {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_not_send, container, false);
    ...
    private void initData() {
        if (IsNetWorkStatus.getActiveNetwork(getContext()) != null) {//有网络
            presenter = new MyOrder_Presenter(userPhone, "待发货", this);
            presenter.loadOrder(getContext());
        } else {
            if (aCache.getAsObject("loadOrderNotSend") != null) {
                ArrayList arrayList = (ArrayList) aCache.getAsObject("loadOrderNotSend");
    ...
    private void initUI() {
        ...
        listView = (MyOrder_ListView) view.findViewById(R.id.myOrderNotSend_listView);
        notAdd = (LinearLayout) view.findViewById(R.id.myOrderNotSend_notAdd);
    ...
    public void loadOrder(List<Map<String, String>> list) {
            if (list instanceof ArrayList) {
                ...
                aCache.put("loadOrderNotSend", arrayList);
            }
