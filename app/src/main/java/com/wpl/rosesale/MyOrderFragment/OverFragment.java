 ...
 */
public class OverFragment extends Fragment implements MyOrder_View {
    ...
    private void initData() {
        if (IsNetWorkStatus.getActiveNetwork(getContext()) != null) {//有网络
            presenter = new MyOrder_Presenter(userPhone, "已完成", this);
            presenter.loadOrder(getContext());
        } else {
            if (aCache.getAsObject("loadOrderOver") != null) {
                ArrayList arrayList = (ArrayList) aCache.getAsObject("loadOrderOver");
    ...
    private void initUI() {
        ...
        notAdd = (LinearLayout) view.findViewById(R.id.myOrderOver_notAdd);
        listView = (MyOrder_ListView) view.findViewById(R.id.myOrderOver_listView);
    ...
    public void loadOrder(List<Map<String, String>> list) {
        if (list instanceof ArrayList) {
            ...
            aCache.put("loadOrderOver", arrayList);
        }
