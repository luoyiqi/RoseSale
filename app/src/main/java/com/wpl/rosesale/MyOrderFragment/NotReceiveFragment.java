 ...
 */
public class NotReceiveFragment extends Fragment implements MyOrder_View {
    ...
    private void initData() {
        if (IsNetWorkStatus.getActiveNetwork(getContext()) != null) {//有网络
            presenter = new MyOrder_Presenter(userPhone, "待收货", this);
            presenter.loadOrder(getContext());
        } else {
            if (aCache.getAsObject("loadOrderNotReceive") != null) {
                ArrayList arrayList = (ArrayList) aCache.getAsObject("loadOrderNotReceive");
    ...
    private void initUI() {
        ...
        notAdd = (LinearLayout) view.findViewById(R.id.myOrderNotReceive_notAdd);
        listView = (MyOrder_ListView) view.findViewById(R.id.myOrderNotReceive_listView);
    ...
    public void loadOrder(List<Map<String, String>> list) {
        if (list instanceof ArrayList) {
            ...
            aCache.put("loadOrderNotReceive", arrayList);
        }
